...
CREATE TABLE `documentlink` (
  ...
  PRIMARY KEY (`UID`),
  KEY `FK_DocumentLink_Document_from` (`FKParentDocumentUID`),
  KEY `FK_DocumentLink_Document_to` (`FKChildDocumentUID`),
  CONSTRAINT `FK_DocumentLink_Document_from` FOREIGN KEY (`FKParentDocumentUID`) REFERENCES `document` (`UID`),
  CONSTRAINT `FK_DocumentLink_Document_to` FOREIGN KEY (`FKChildDocumentUID`) REFERENCES `document` (`UID`)
