...
namespace FCMMySQLBusinessLibrary.Model.ModelClient
{
    public class ClientOtherInfo
    {
        ...
        public void Add()
        {
            ...
            using (var connection = new MySqlConnection(ConnString.ConnectionString))
            {
                ...
                using (var command = new MySqlCommand(
                                            commandString, connection))
                {
                    command.Parameters.Add("@UID", MySqlDbType.VarChar).Value = nextUID;
                    command.Parameters.Add("@FKClientUID", MySqlDbType.VarChar).Value = FKClientUID;
                    command.Parameters.Add("@RCFieldCode", MySqlDbType.VarChar).Value = RCFieldCode;
                    command.Parameters.Add("@FieldValueText", MySqlDbType.VarChar).Value = FieldValueText;
        ...
        private static void LoadObject(MySqlDataReader reader, ClientOtherInfo clientOther)
        {
