...
namespace FCMMySQLBusinessLibrary.Model.ModelClientDocument
{
    public class ClientDocumentLink
    {
        ...
        public Model.ModelDocument.Document parentDocument;
        public Model.ModelDocument.Document childDocument;
        ...
        public void Add()
        {
            ...
            using (var connection = new MySqlConnection(ConnString.ConnectionString))
            {
                                            ...
                                            commandString, connection))
                {
                    ...
                    command.Parameters.Add("@FKClientDocumentSetUID ", MySqlDbType.Int32).Value = FKClientDocumentSetUID;
