...
namespace FCMMySQLBusinessLibrary
{
    public class ClientWorkHoursAllocation
    {
        ...
        private void AddSQLParameters(MySqlCommand command)
        {
            ...
            command.Parameters.Add(FieldName.UID.ToString(), MySqlDbType.Int32).Value = UID;
            command.Parameters.Add(FieldName.Date.ToString(), MySqlDbType.Date).Value = Date;
            command.Parameters.Add(FieldName.FKClientWorkIsFor.ToString(), MySqlDbType.Int32).Value = FKClientWorkIsFor;
            command.Parameters.Add(FieldName.FKCompanyUID.ToString(), MySqlDbType.Int32).Value = FKCompanyUID;
            command.Parameters.Add(FieldName.FKEmployeeUID.ToString(), MySqlDbType.Int32).Value = FKEmployeeUID;
            command.Parameters.Add(FieldName.FKInvoiceItemID.ToString(), MySqlDbType.Int32).Value = FKInvoiceItemID;
            command.Parameters.Add(FieldName.FKInvoiceUID.ToString(), MySqlDbType.Int32).Value = FKInvoiceUID;
            command.Parameters.Add(FieldName.FKTaskUID.ToString(), MySqlDbType.Int32).Value = FKTaskUID;
            command.Parameters.Add(FieldName.Hours.ToString(), MySqlDbType.Int32).Value = Hours;
