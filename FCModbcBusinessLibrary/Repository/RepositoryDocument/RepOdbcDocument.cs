...
namespace FCModbcBusinessLibrary.Repository.RepositoryDocument
{
    /// <summary>
    ...
    internal class RepDocument : Document
    {
        ...
        public static string GetName(int documentUID)
        {
            ...
            using (var connection = new OdbcConnection(ConnString.ConnectionString))
            {
                ...
                using (var command = new OdbcCommand(
                                            commandString, connection))
                {
                    command.Parameters.Add("@UID", OdbcType.BigInt).Value = documentUID;
                    ...
                    if (reader.Read())
                    {
                        ...
                        {
                            LogFile.WriteToTodaysLogFile("Error retrieving name: " + exception, "", "", "RepOdbcDocument.cs");
                        }
                    }
                }
            }
        ...
        public static void SetToVoid(int DocumentUID)
        {
            ...
            using (var connection = new OdbcConnection(ConnString.ConnectionString))
            {
                ...
                {
                    command.Parameters.Add("@UID", OdbcType.BigInt).Value = DocumentUID;
                    command.Parameters.Add("@IsVoid", OdbcType.VarChar).Value = 'Y';
        ...
        /// </summary>
        /// <returns></returns>
        private static int Add(HeaderInfo headerInfo, FCMMySQLBusinessLibrary.Model.ModelDocument.Document docadd)
        {
            ...
            using (var connection = new OdbcConnection(ConnString.ConnectionString))
            {
                ...
                using (var command = new OdbcCommand(
                                          commandString, connection))
                {
                    command.Parameters.Add("@UID", OdbcType.BigInt).Value = docadd.UID;
                    command.Parameters.Add( "@CUID", OdbcType.VarChar ).Value = docadd.CUID;
                    command.Parameters.Add( "@Name", OdbcType.VarChar ).Value = docadd.Name;
                    command.Parameters.Add( "@DisplayName", OdbcType.VarChar ).Value = docadd.DisplayName;
                    command.Parameters.Add( "@SequenceNumber", OdbcType.VarChar ).Value = docadd.SequenceNumber;
                    command.Parameters.Add( "@IssueNumber", OdbcType.Decimal ).Value = docadd.IssueNumber;
                    command.Parameters.Add( "@Location", OdbcType.VarChar ).Value = docadd.Location;
                    command.Parameters.Add( "@Comments", OdbcType.VarChar ).Value = docadd.Comments;
                    command.Parameters.Add( "@FileName", OdbcType.VarChar ).Value = docadd.FileName;
                    command.Parameters.Add( "@SimpleFileName", OdbcType.VarChar ).Value = docadd.SimpleFileName;
                    command.Parameters.Add( "@SourceCode", OdbcType.VarChar ).Value = docadd.SourceCode;
                    command.Parameters.Add("@FKClientUID", OdbcType.BigInt).Value = docadd.FKClientUID;
                    command.Parameters.Add( "@IsVoid", OdbcType.VarChar ).Value = docadd.IsVoid;
                    command.Parameters.Add( "@Skip", OdbcType.VarChar ).Value = docadd.Skip;
                    command.Parameters.Add( "@ParentUID", OdbcType.VarChar ).Value = docadd.ParentUID;
                    command.Parameters.Add( "@RecordType", OdbcType.VarChar ).Value = docadd.RecordType;
                    command.Parameters.Add( "@IsProjectPlan", OdbcType.VarChar ).Value = docadd.IsProjectPlan;
                    command.Parameters.Add( "@DocumentType", OdbcType.VarChar ).Value = docadd.DocumentType;
                    command.Parameters.Add( "@FileExtension", OdbcType.VarChar ).Value = docadd.FileExtension;
                    command.Parameters.Add( "@Status", OdbcType.VarChar ).Value = docadd.Status;
                    command.Parameters.Add( "@RecordVersion", OdbcType.VarChar ).Value = docadd.RecordVersion;
                    command.Parameters.Add( "@UserIdCreatedBy", OdbcType.VarChar ).Value = docadd.UserIdCreatedBy;
                    command.Parameters.Add( "@UserIdUpdatedBy", OdbcType.VarChar ).Value = docadd.UserIdUpdatedBy;
                    command.Parameters.Add( "@CreationDateTime", OdbcType.DateTime ).Value = docadd.CreationDateTime;
                    command.Parameters.Add( "@UpdateDateTime", OdbcType.DateTime ).Value = docadd.UpdateDateTime;
        ...
        // -----------------------------------------------------
        private static void UpdateVersion(HeaderInfo headerInfo, FCMMySQLBusinessLibrary.Model.ModelDocument.Document indocument)
        {
            ...
            using (var connection = new OdbcConnection(ConnString.ConnectionString))
            {
                ...
                using (var command = new OdbcCommand(
                                            commandString, connection))
                {
                    command.Parameters.Add("@CUID", OdbcType.VarChar).Value = indocument.CUID;
                    command.Parameters.Add("@Name", OdbcType.VarChar).Value = indocument.Name;
                    command.Parameters.Add("@IssueNumber", OdbcType.Decimal).Value = indocument.IssueNumber;
                    command.Parameters.Add("@Location", OdbcType.VarChar).Value = indocument.Location;
                    command.Parameters.Add("@FileName", OdbcType.VarChar).Value = indocument.FileName;
            ...
            GetRoot(HeaderInfo headerInfo)
        {
            ...
            FCMMySQLBusinessLibrary.Model.ModelDocument.Document docreturn = new FCMMySQLBusinessLibrary.Model.ModelDocument.Document();
        ...
        //    Update Document
        // -----------------------------------------------------
        private static int Update(HeaderInfo headerInfo, FCMMySQLBusinessLibrary.Model.ModelDocument.Document docupdate)
        {
            ...
            using (var connection = new OdbcConnection(ConnString.ConnectionString))
            {
                ...
                using (var command = new OdbcCommand(
                                            commandString, connection))
                {
                    command.Parameters.Add("@UID", OdbcType.VarChar).Value = docupdate.UID;
                    command.Parameters.Add("@CUID", OdbcType.VarChar).Value = docupdate.CUID;
                    command.Parameters.Add("@Name", OdbcType.VarChar).Value = docupdate.Name;
                    command.Parameters.Add("@DisplayName", OdbcType.VarChar).Value = docupdate.DisplayName;
                    command.Parameters.Add("@SequenceNumber", OdbcType.VarChar).Value = docupdate.SequenceNumber;
                    command.Parameters.Add("@IssueNumber", OdbcType.Decimal).Value = docupdate.IssueNumber;
                    command.Parameters.Add("@Location", OdbcType.VarChar).Value = docupdate.Location;
                    command.Parameters.Add("@IsProjectPlan", OdbcType.VarChar).Value = docupdate.IsProjectPlan;
                    command.Parameters.Add("@Comments", OdbcType.VarChar).Value = docupdate.Comments;
                    command.Parameters.Add("@FileName", OdbcType.VarChar).Value = docupdate.FileName;
                    command.Parameters.Add("@SimpleFileName", OdbcType.VarChar).Value = docupdate.SimpleFileName;
                    command.Parameters.Add("@SourceCode", OdbcType.VarChar).Value = docupdate.SourceCode;
                    command.Parameters.Add("@FKClientUID", OdbcType.BigInt).Value = docupdate.FKClientUID;
                    command.Parameters.Add("@ParentUID", OdbcType.BigInt).Value = docupdate.ParentUID;
                    command.Parameters.Add("@DocumentType", OdbcType.VarChar).Value = docupdate.DocumentType;
                    command.Parameters.Add("@UserIdUpdatedBy", OdbcType.VarChar).Value = docupdate.UserIdUpdatedBy;
                    command.Parameters.Add("@UpdateDateTime", OdbcType.DateTime).Value = docupdate.UpdateDateTime;
        ...
        public static int Save(HeaderInfo headerInfo, Document indocument, string type = null)
        {
            ...
            FCMMySQLBusinessLibrary.Model.ModelDocument.Document currentdocument = Read(false, indocument.UID);
        ...
        public static void LoadDocumentFromReader(
                               FCMMySQLBusinessLibrary.Model.ModelDocument.Document retDocument,
                               string tablePrefix,
            ...
            using (var connection = new OdbcConnection(ConnString.ConnectionString))
            {
                                      ...
                                      commandString, connection))
                {
                    ...
                    using (OdbcDataReader reader = command.ExecuteReader())
                    {
                        while (reader.Read())
                        {
                            FCMMySQLBusinessLibrary.Model.ModelDocument.Document _Document = new FCMMySQLBusinessLibrary.Model.ModelDocument.Document();
        ...
        public static void ListInTree(
            ...
            FCMMySQLBusinessLibrary.Model.ModelDocument.Document root)
        {

            // Find root folder
            //
            FCMMySQLBusinessLibrary.Model.ModelDocument.Document rootDocument = new FCMMySQLBusinessLibrary.Model.ModelDocument.Document();
        ...
        public void UpdateFieldString( int UID, string fieldName, string contents )
        {
            ...
            using ( var connection = new OdbcConnection( ConnString.ConnectionString ) )
            {
                ...
                using ( var command = new OdbcCommand(
                                            commandString, connection ) )
                {
                    command.Parameters.Add( "@UID", OdbcType.BigInt ).Value = UID;
                    command.Parameters.Add( "@contents", OdbcType.VarChar ).Value = contents;
